    ...
    <v-container fluid class="background-color" id="projects">
      <v-flex class="projects-wrapper">
         <v-layout align-center column mt-10 mx-15 mb-2>
            <v-flex  class="display-3 font-weight-thin white--text text-xs-center mb-1">Projects</v-flex>
         </v-layout>
         <v-divider></v-divider>
         <v-flex class="projects-text">
            <p class="text-center mt6">
                 I host most of the projects I make publicly on my personal <a href="https://github.com/joangro">GitHub page</a>. Here you can see all of them, fetched using the <a href="https://developer.github.com/">GitHub API</a>. 
            </p>
            <p class="text-center">
                              ...
                              <v-hover v-slot:default="{ hover }">
                                <v-card 
                                 ...
                                 class="background-color-clearer">
                                  <v-card-title class="justify-center" mb-2><h4>{{ item.name }}</h4></v-card-title>
                                  <v-card-text class="justify-center">
                                    <span  v-for="(item, key) in item.languages">
                                      <v-chip class="chip-wrapper" v-if="key == 'Python'">
                                        <v-icon input-value="Python" left>mdi-language-python</v-icon>
                                        Python
                                      </v-chip>
                                      ...
                                      <v-chip class="chip-wrapper" v-if="key == 'Dockerfile'">
                                      ...
                                      <v-chip class="chip-wrapper" v-if="key == 'JavaScript'">
                                  ...
                                  <v-divider class="mx-4"></v-divider>
                                  <v-card-text>
                                    <div class="body-2">Last updated: {{ item.created_at }}</div>
                                  </v-card-text>
